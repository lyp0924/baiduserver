...
function spicepress_archive_page_title(){
	if( is_archive() )
	{
		...
		echo '<div class="page-title wow bounceInLeft animated" ata-wow-delay="0.4s"><h2>';
	...
	else
	{
		...
		echo '<div class="page-title wow bounceInLeft animated" ata-wow-delay="0.4s"><h2>'.wp_kses( force_balance_tags( get_the_title()), $allowed_html ).'</h2></div>';
	}
}
