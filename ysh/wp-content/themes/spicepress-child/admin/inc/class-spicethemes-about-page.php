...
if (!class_exists('SpiceThemes_About_Page')) {
	...
	public function chilly_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_chilly-welcome' == $hook_suffix ) {
			...
			wp_enqueue_style( 'chilly-info-screen-css', get_stylesheet_directory_uri() . '/admin/assets/css/welcome.css' );
			
			wp_enqueue_style( 'chilly-info-css', get_stylesheet_directory_uri() . '/admin/assets/css/bootstrap.css' );
			
			wp_enqueue_style('chilly-theme-info-style', get_stylesheet_directory_uri() . '/admin/assets/css/welcome-page-styles.css');
			
			wp_enqueue_style('welcome_customizer', get_stylesheet_directory_uri() . '/admin/assets/css/welcome_customizer.css');
			wp_enqueue_script('plugin-install');
			wp_enqueue_script('updates');
			wp_enqueue_script('chilly-companion-install', get_stylesheet_directory_uri() . '/admin/assets/js/plugin-install.js', array('jquery'));
			wp_enqueue_script('chilly-ajax', get_stylesheet_directory_uri() . '/admin/assets/js/ajax.js', array('jquery'));
	...
	public function chilly_scripts_for_customizer() {
		...
		wp_enqueue_style( 'chilly-info-screen-customizer-css', get_stylesheet_directory_uri() . '/admin/assets/css/welcome_customizer.css' );
		wp_enqueue_script( 'chilly-info-screen-customizer-js', get_stylesheet_directory_uri() . '/admin/assets/js/welcome_customizer.js', array('jquery'), '20120206', true );
	  ...
	  <div class="container-fluid">
		<div class="row">
		<div class="col-md-12">
			<div class="wrap theme-info-wrap chilly-wrap">
	...
	/**
		...
		public function chilly_changelog() {
			...
			<div class="wrap about-wrap">
				...
				<?php
				$changelog_file = apply_filters( 'chilly_changelog_file', get_stylesheet_directory() . '/changelog.txt' );
