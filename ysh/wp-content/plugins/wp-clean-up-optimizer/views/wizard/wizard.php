				...
				<div class="page-container header-wizard">
					<div class="page-content">
						<div class="row row-custom row-bg">
							...
							<div class="col-md-4 center">
								<img src="<?php echo esc_url( plugins_url( 'assets/global/img/clean-up-icon.png', dirname( dirname( __FILE__ ) ) ) ); ?>" height="110" width="110">
							</div>
							<div class="col-md-1">
							</div>
						</div>
						...
						<div class="row row-custom">
							...
							<div class="col-md-12 terms">
								<a href="<?php echo esc_url( TECH_BANKER_BETA_URL ) . 'privacy-policy/'; ?>" target="_blank"><?php echo esc_attr( __( 'Privacy Policy', 'wp-clean-up-optimizer' ) ); ?></a>
									<span> - </span>
								<a href="<?php echo esc_url( TECH_BANKER_BETA_URL ) . 'terms-conditions/'; ?>" target="_blank"><?php echo esc_attr( __( 'Terms &amp; Conditions', 'wp-clean-up-optimizer' ) ); ?></a>
							</div>
						</div>
					</div>
				</div>
