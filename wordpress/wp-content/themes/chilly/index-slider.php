<?php
	...
	<section class="slider" style="position:relative;">
		<div class="item" style="background-image:url(<?php echo $home_slider_image; ?>); width: 100%; height: 40vh; background-position: center center; background-size: cover; z-index: 0;" >
