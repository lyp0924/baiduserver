...
if (!class_exists('SpiceThemes_About_Page')) {
	...
	public function spicepress_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_spicepress-welcome' == $hook_suffix ) {
			...
			wp_enqueue_style( 'spicepress-info-screen-css', get_template_directory_uri() . '/admin/assets/css/welcome.css' );
			
			wp_enqueue_style( 'spicepress-info-css', get_template_directory_uri() . '/admin/assets/css/bootstrap.css' );
			
			wp_enqueue_style('spicepress-theme-info-style', get_template_directory_uri() . '/admin/assets/css/welcome-page-styles.css');
			
			wp_enqueue_style('welcome_customizer', get_template_directory_uri() . '/admin/assets/css/welcome_customizer.css');
			wp_enqueue_script('plugin-install');
			wp_enqueue_script('updates');
			wp_enqueue_script('spicepress-companion-install', get_template_directory_uri() . '/admin/assets/js/plugin-install.js', array('jquery'));
			wp_enqueue_script('spicepress-ajax', get_template_directory_uri() . '/admin/assets/js/ajax.js', array('jquery'));
	...
	public function spicepress_scripts_for_customizer() {
		...
		wp_enqueue_style( 'spicepress-info-screen-customizer-css', get_template_directory_uri() . '/admin/assets/css/welcome_customizer.css' );
		wp_enqueue_script( 'spicepress-info-screen-customizer-js', get_template_directory_uri() . '/admin/assets/js/welcome_customizer.js', array('jquery'), '20120206', true );
		...
		public function welcome_admin_notice() {
			...
			<div class="updated notice is-dismissible spicepress-notice">
				...
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=spicepress-welcome' ) ); ?>" class="button button-blue-secondary button_spicepress" style="text-decoration: none;"><?php _e('Get started with SpicePress','spicepress'); ?></a></p>
			</div>
			<?php
		}
	...
	/**
		...
		public function spicepress_changelog() {
			...
			<div class="wrap about-wrap">
				...
				<?php
				$changelog_file = apply_filters( 'spicepress_changelog_file', get_template_directory() . '/changelog.txt' );
